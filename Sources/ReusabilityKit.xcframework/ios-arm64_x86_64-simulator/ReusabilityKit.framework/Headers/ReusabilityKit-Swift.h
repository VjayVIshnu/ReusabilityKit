...
#ifndef REUSABILITYKIT_SWIFT_H
#define REUSABILITYKIT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ReusabilityKit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC14ReusabilityKit8CardView")
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC14ReusabilityKit15FloatRatingView")
...
SWIFT_PROTOCOL("_TtP14ReusabilityKit23FloatRatingViewDelegate_")
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC14ReusabilityKit12RoundedImage")
...
@interface UIViewController (SWIFT_EXTENSION(ReusabilityKit)) <UIGestureRecognizerDelegate>
- (BOOL)gestureRecognizer:(UIGestureRecognizer * _Nonnull)gestureRecognizer shouldReceiveTouch:(UITouch * _Nonnull)touch SWIFT_WARN_UNUSED_RESULT;
@end


@interface UIViewController (SWIFT_EXTENSION(ReusabilityKit))
